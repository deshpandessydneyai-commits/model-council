...
export default function Help() {
  return (
    <div className="max-w-[1600px] mx-auto px-6 pt-16 pb-32 min-h-screen bg-[#F5F4F0] dark:bg-[#0A0A0A]">
      ...
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Help & FAQ</h1>
        <p className="text-gray-600 dark:text-gray-400">Everything you need to know about Model Council</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <section className="border border-[#E2E0DA] dark:border-glass bg-white dark:bg-[#0F0F1A] rounded-lg p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">How do I start a debate?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">What should I ask?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">How long does a debate take?</h3>
              <p className="text-gray-700 dark:text-gray-300">
        ...
        <section className="border border-[#E2E0DA] dark:border-glass bg-white dark:bg-[#0F0F1A] rounded-lg p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Round 1 — Independent</h3>
              <p className="text-gray-700 dark:text-gray-300">
                All four models see only your prompt and respond independently. Responses are generated in parallel.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Round 2 — Critique & Update</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Round 3 — Final Statements (Conditional)</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Synthesis</h3>
              <p className="text-gray-700 dark:text-gray-300">
        ...
        <section className="border border-[#E2E0DA] dark:border-glass bg-white dark:bg-[#0F0F1A] rounded-lg p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">What is Decision Context?</h3>
              <p className="text-gray-700 dark:text-gray-300">
                When you start a debate, select a <strong>stakes level</strong> that reflects how important the decision is. Model Council uses the GPS Framework to automatically adjust prompting rigor:
              </p>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Domain Detection</h3>
              <p className="text-gray-700 dark:text-gray-300">
                The system automatically detects your question's domain (Medical, Academic, Technical, Legal, Creative, Policy, Personal, Business) and tailors prompts accordingly.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border border-[#E2E0DA] dark:border-glass bg-white dark:bg-[#0F0F1A] rounded-lg p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Web Search</h3>
              <p className="text-gray-700 dark:text-gray-300">
                Toggle "Web Search" in the setup modal to augment model responses with live web results. Adds ~$0.004 per search.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Session History</h3>
              <p className="text-gray-700 dark:text-gray-300">
                All debates are automatically saved to browser localStorage. Click "Recent" in the sidebar to restore previous debates.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Export</h3>
              <p className="text-gray-700 dark:text-gray-300">
                Click "Export Markdown" to download the entire debate (all rounds + verdict) as a `.md` file. Great for sharing or publishing.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Decision Context</h3>
              <p className="text-gray-700 dark:text-gray-300">
                Set the stakes level (Exploratory, Implemented, Critical, Time-Critical, Resource-Constrained) and the system automatically adjusts prompting depth and rigor based on your domain and question type.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border border-[#E2E0DA] dark:border-glass bg-white dark:bg-[#0F0F1A] rounded-lg p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">How much does a debate cost?</h3>
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Typically $0.10 – $0.40 USD</strong> depending on prompt length and model verbosity. Web Search adds a few cents.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Where do I buy credits?</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">What if I run out of credits?</h3>
              <p className="text-gray-700 dark:text-gray-300">
        ...
        <section className="border border-[#E2E0DA] dark:border-glass bg-white dark:bg-[#0F0F1A] rounded-lg p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Debate won't start</h3>
              <p className="text-gray-300 mb-2">
                Check:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-300 text-sm">
                <li>You entered a prompt</li>
                <li>Your OpenRouter API key is set in <code className="bg-gray-200 dark:bg-[#1A1A2E] px-1 py-0.5 rounded text-xs text-gray-900 dark:text-gray-200 font-mono">.env.local</code></li>
                <li>You have credits remaining in your OpenRouter account</li>
                <li>The dev server is running</li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Models aren't responding</h3>
              <p className="text-gray-700 dark:text-gray-300">
                This usually means OpenRouter is rate-limited or experiencing issues. Wait a moment and try again.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">History isn't saving</h3>
              <p className="text-gray-700 dark:text-gray-300">
                Check your browser's localStorage quota. If you're out of space, clear old debates in browser settings.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-indigo-600 dark:text-violet-400 mb-2">Something else is broken?</h3>
              <p className="text-gray-700 dark:text-gray-300">
