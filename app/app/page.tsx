    ...
    <>
      ...
      <div className="max-w-[1600px] mx-auto px-6 pt-16 pb-32">
        ...
        <section className="mt-8">
          <div className="mono-meta text-gray-500 dark:text-gray-400 mb-2 text-sm">Your Question</div>
          <textarea
            value={prompt}
            ...
            rows={3}
            disabled={running}
            className="w-full border border-gray-300 dark:border-glass bg-white dark:bg-[#1A1A2E] p-4 text-base focus:outline-none focus:border-indigo-500 dark:focus:border-violet-500 focus:bg-gray-50 dark:focus:bg-[#222235] resize-none text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 rounded-lg transition-colors"
          />
          {error && (
        ...
        {/* Rounds */}
        {orderedRounds.map((n) => (
          <RoundSection key={n} round={n} label={rounds[n].label} outputs={rounds[n].outputs} doneSet={rounds[n].doneSet} previousRoundOutputs={n > 1 ? rounds[n - 1].outputs : {}} />
        ))}
